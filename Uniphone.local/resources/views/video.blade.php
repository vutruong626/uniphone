					...
					<div class="row">
						<div class="col-lg-12">
							<div class="hero-nav-area">
								<h1 class="text-white">Video Post</h1>
								<p class="text-white link-nav"><a href="index-2.html">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="#">Post Types </a><span class="lnr lnr-arrow-right"></span><a href="video-post.html">Video Post </a></p>
							</div>
						</div>
						<div class="col-lg-12">
								...
								<div class="feature-img-thumb relative">
									<div class="video-box">
										...
										<div id="thumbnail_container" class="thumbnail_container">
											<img class="img-fluid" id="thumbnail" alt="" src="img/f1.jpg">
