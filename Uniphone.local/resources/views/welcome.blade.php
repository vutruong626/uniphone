                    ...
                    <div class="row small-gutters">
                        <div class="col-lg-8 top-post-left">
                            <div class="feature-image-thumb relative">
                                ...
                                <img class="img-fluid" src="https://www.chuahoangphap.com.vn/Images/News/hoangphap_tha-thu_full_18242018_032431.jpg" style="height: 535px;" alt="">
                            </div>
                        ...
                        <div class="col-lg-4 top-post-right">
                            <div class="single-top-post">
                                <div class="feature-image-thumb relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="http://giacngo.vn/UserImages/2014/05/10/11/BTN_0108.jpg" alt="">
                                </div>
                                <div class="top-post-details">
                                    <ul class="tags">
                                        <li><a href="#">Thời Sự</a></li>
                                    </ul>
                                    <a href="image-post.html">
                                        <h4>Phước lạc thay sự xuất hiện của chư Phật</h4>
                                    </a>
                                    <ul class="meta">
                                        <li><a href="#"><span class="lnr lnr-user"></span>Mark wiens</a></li>
                                        <li><a href="#"><span class="lnr lnr-calendar-full"></span>03 April, 2018</a></li>
                            ...
                            <div class="single-top-post mt-10">
                                <div class="feature-image-thumb relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="http://m.f29.img.vnecdn.net/2013/11/16/Bo-truong-Dinh-la-thang-JPG-1426-1384585560.jpg" alt="">
                                </div>
                                <div class="top-post-details">
                                    <ul class="tags">
                                        <li><a href="#">Thời Sự</a></li>
                                    ...
                                    <a href="image-post.html">
                                        <h4>Đại lễ cầu siêu cho 8.000 nạn nhân tai nạn giao thông</h4>
                                    </a>
                                    <ul class="meta">
                                        <li><a href="#"><span class="lnr lnr-user"></span>Mark wiens</a></li>
                                        <li><a href="#"><span class="lnr lnr-calendar-full"></span>03 April, 2018</a></li>
                                ...
                                <div class="single-latest-post row align-items-center">
                                    <div class="col-lg-5 post-left">
                                        <div class="feature-img relative">
                                            <div class="overlay overlay-bg"></div>
                                            <img class="img-fluid" src="http://www.mediafire.com/convkey/1fd9/x4z87jsezvujh1gfg.jpg" alt="">
                                        </div>
                                        <ul class="tags">
